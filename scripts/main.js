...
var cities = [];
cities[0] = new City('Xi Liang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[1] = new City('Wu Wei', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[2] = new City('Tian Shui', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[3] = new City('An Ding', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[4] = new City('Chang An', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[5] = new City('Luo Yang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[6] = new City('He Nei', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[7] = new City('Pu Yang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
...
cities[11] = new City('Xia Pi', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[12] = new City('Shou Chun', '-', 13000, 89000, 3200, 3200, 2800, 4000, 460, 460, 600, 2800, 80, '-');
cities[13] = new City('Lu Jiang', '-', 11500, 86000, 3200, 3200, 2800, 4000, 440, 440, 600, 2800, 80, '-');
cities[14] = new City('Ru Nan', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[15] = new City('Ye', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[16] = new City('Shang Dang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[17] = new City('Jin Yang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[18] = new City('Bei Hai', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[19] = new City('Ping Yuan', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[20] = new City('Nan Pi', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[21] = new City('Ji', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[22] = new City('Bei Ping', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[23] = new City('Xiang Ping', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[24] = new City('Han Zhong', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[25] = new City('Wu Du', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[26] = new City('Cheng Du', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[27] = new City('Zi Tong', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[28] = new City('Jiang Zhou', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[29] = new City('Yong An', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[30] = new City('Jian Ning', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[31] = new City('Yun Nan', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[32] = new City('Yong Chang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[33] = new City('Wan', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[34] = new City('Xin Ye', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[35] = new City('Xiang Yang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[36] = new City('Shang Yong', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[37] = new City('Jiang Ling', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[38] = new City('Jiang Xia', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[39] = new City('Wu Ling', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[40] = new City('Chang Sha', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[41] = new City('Ling Ling', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[42] = new City('Gui Yang', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[43] = new City('Wu', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[44] = new City('Jian Ye', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[45] = new City('Chai Sang', '-', 8000, 70000, 3200, 3200, 2800, 4000, 420, 420, 600, 2800, 80, '-');
cities[46] = new City('Hui Ji', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[47] = new City('Jian An', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[48] = new City('Nan Hai', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
cities[49] = new City('Jiao Zhi', '-', 5000, 100000, 3200, 3200, 2800, 4000, 200, 200, 600, 2800, 80, '-');
